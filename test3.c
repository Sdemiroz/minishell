...
/*   Updated: 2025/03/21 07:09:59 by sdemiroz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_minishell	*create_example3(void)
{
	...
	t_pipe				*pipe1;
	t_pipe				*pipe2;
	t_redirection_list	*redir_list1;
	t_redirection_list	*redir_list2;
	...
	redir_list1 = malloc(sizeof(t_redirection_list));
	redir_list2 = malloc(sizeof(t_redirection_list));
